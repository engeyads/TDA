    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-left">
                <h2 class="section-heading text-uppercase">{{ __('about.subtitle') }}</h2>
            ...
            <div class="col-md-1">
                <figure class="cascading_image">
                    <div class="cascading_inner animation fade-in">
                        <img src="{{ asset('/assets/img/about/ca22.png') }}" width="430" alt  class="retina_size retina_active lazyloaded">
                    </div>
                </figure>
            </div>
        </div>
